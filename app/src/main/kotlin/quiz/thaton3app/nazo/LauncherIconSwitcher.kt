...
object LauncherIconSwitcher {
    ...
    val OPTIONS: List<AppIconOption> = listOf(
        ...
        AppIconOption(
            ...
            alias = "LauncherNeon",
            label = "Neon N",
            blurb = "The initial as a glowing neon sign",
            startColor = 0xFF10243A,
            endColor = 0xFF061018,
            splashTheme = R.style.Theme_Nazo_Splash_Neon,
            splashColor = 0xFF0C1420,
            introMark = R.drawable.ic_mark_n_neon_silhouette,
            introStyle = IntroStyle.N_STROKE,
            previewMark = R.drawable.ic_mark_n_neon,
        ),
        AppIconOption(
            id = "nbrush",
            alias = "LauncherBrush",
